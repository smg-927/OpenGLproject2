...
int main()
{
    ...
    Shader lightingShader("shader_4_6.vert", "shader_4_6.frag");
    Shader lightCubeShader("lighting_vertex.vert", "lighting_fragment.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // light properties
        lightingShader.setVec3("light.ambient", 0.2, 0.2f, 0.2f);
